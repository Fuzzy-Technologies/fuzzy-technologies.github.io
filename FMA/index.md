...
<table class="table-clean" style="margin-top: 2rem; margin-bottom: 2rem;">
  <tr>
    ...
    <td style="vertical-align: top;">
      ...
      <p>💼 Мы предлагаем индивидуальные условия для клиентов с крупными портфелями: аренда робота для торговли на вашем брокерском счёте, подключение к автоследованию за сигналами и индивидуальная настройка стратегии под различные наборы инструментов.</p>
      <p>📡 Сигналы, роботы и настройки — для пользователей, которые не хотят тратить время на ручную торговлю.</p>
      <p>💰 Торговля ведётся на вашем брокерском счёте с доверенным доступом для робота. Мы зарабатываем по модели success fee + фиксированная аренда. У нас есть прототип робота-трейдера для краткосрочных инвестиций, который умеет торговать на счёте пользователя полностью автономно.</p>
