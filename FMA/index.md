...
<table class="table-clean" style="margin-top: 2rem; margin-bottom: 2rem;">
  <tr>
    ...
    <td style="vertical-align: top;">
      <h3 style="margin-top: 0;">📈 Сервис краткосрочных сигналов по рынку российских акций (бесплатный)</h3>
...
<table class="table-clean" style="margin-top: 2rem; margin-bottom: 2rem;">
  <tr>
    ...
    <td style="vertical-align: top;">
      <h3 style="margin-top: 0;">🤖 Аренда робота для автоматической торговли (в разработке)</h3>
      <p>💼 Мы готовим индивидуальные условия для клиентов с крупными портфелями: аренда робота для торговли на вашем брокерском счёте, подключение к автоследованию за сигналами и индивидуальная настройка стратегии под различные наборы инструментов.</p>
      <p>📡 Сигналы, роботы и настройки — для пользователей, которые не хотят тратить время на ручную торговлю.</p>
      <p>💰 Торговля ведётся на вашем счёте с доверенным доступом для робота. Мы зарабатываем по модели success fee + фиксированная аренда. У нас уже есть прототип робота-трейдера для краткосрочных инвестиций, который умеет торговать на счёте пользователя полностью автономно.</p>
      <p>🛠️ Платформа и автоследование через Тинькофф — в разработке. <a href="https://t.me/fuzzy_technologies"><b>Напишите нам для обсуждения условий</b></a></p>
    </td>
  </tr>
</table>
