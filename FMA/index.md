...
<table class="table-clean" style="margin-top: 2rem; margin-bottom: 2rem;">
  <tr>
    ...
    <td style="vertical-align: top;">
      ...
      <p>💰 Торговля ведётся на вашем счёте с доверенным доступом для робота. Мы зарабатываем по модели success fee + фиксированная аренда. У нас есть прототип робота-трейдера для краткосрочных инвестиций, который умеет торговать на счёте пользователя полностью автономно.</p>
