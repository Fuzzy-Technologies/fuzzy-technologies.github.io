...
Добро пожаловать на сайт компании **Fuzzy Technologies** — мы разрабатываем платформы и сервисы для автоматической биржевой аналитики и трейдинга.


<hr/>

Наш девиз: Technologies · Knowledge · Science
