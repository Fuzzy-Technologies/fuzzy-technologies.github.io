...
⚙️ **TKSBrokerAPI** — это платформа с открытым исходным кодом собственной разработки для упрощённой работы с брокером Т-Инвестиции через REST API и автоматизации сбора биржевой аналитики и торговых сценариев на Python. 
...
TKSBrokerAPI легко встраивается в CI/CD, автоматизированные сценарии и конвейеры обработки данных. Платформа подойдёт как для локальной аналитики, так и для полноценных бэктестов и торговых роботов.
...
- 🧠 Pandas DataFrame — для анализа данных и алгоритмов
...
1. **Из командной строки**  
   ...
   Запуск сценариев, экспорт данных, получение информации — через командную строку с параметрами.
