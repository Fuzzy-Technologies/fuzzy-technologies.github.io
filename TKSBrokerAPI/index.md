...
⚠️ Актуальная и наиболее оптимизированная dev-версия на текущий момент в PyPI: [v1.6.dev240](https://pypi.org/project/tksbrokerapi/1.6.dev240/) (release-версия платформы ожидается до 1 июня 2025).

```shell
pip install tksbrokerapi==1.6.dev240
```
