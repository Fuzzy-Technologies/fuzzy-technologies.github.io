...
⚠️ Актуальная dev-версия на текущий момент в PyPI: [v1.6.dev229](https://pypi.org/project/tksbrokerapi/1.6.dev229/) (release-версия платформы ожидается до 1 июня 2025).

```shell
pip install tksbrokerapi==1.6.dev229
```
